...
public class CourseDaoImpl implements CourseDao {
	...
	@Override
	public /*Course[]*/ ArrayList<Course> getAllCourses() {
	...
	public boolean addEmployeeForCourseId(String cID, Employee employee) {
		/*Course[]*/ ArrayList<Course> courses=courseDataBase.getCourses();
		for(Course course:courses) {
			if(course.getCourseId().equals(cID)) {
				/*Employee[]*/ ArrayList<Employee> employees=course.getEmployees();
