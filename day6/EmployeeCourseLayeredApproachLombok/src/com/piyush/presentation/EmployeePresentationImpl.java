...
public class EmployeePresentationImpl implements EmployeePresentation {
	...
	public void performMenu(int choice) {
		...
		switch(choice) {
		case 1:
			/*Course[]*/ ArrayList<Course> courses=courseService.getAllCoursesForEmployee();
		...
		case 4:
			...
			/*Employee[]*/ ArrayList<Employee> empls=courseService.listOfEmployeesForCourse(courseId);
